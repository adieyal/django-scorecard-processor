...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Response.baseline'
        db.add_column('scorecard_processor_response', 'baseline', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Response.baseline'
        db.delete_column('scorecard_processor_response', 'baseline')
