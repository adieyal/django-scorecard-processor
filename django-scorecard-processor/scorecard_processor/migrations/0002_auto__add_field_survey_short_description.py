...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Survey.short_description'
        db.add_column('scorecard_processor_survey', 'short_description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Survey.short_description'
        db.delete_column('scorecard_processor_survey', 'short_description')
