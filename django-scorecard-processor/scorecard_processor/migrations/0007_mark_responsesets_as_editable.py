...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ResponseSet.editable'
        db.add_column('scorecard_processor_responseset', 'editable', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ResponseSet.editable'
        db.delete_column('scorecard_processor_responseset', 'editable')
