...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ResponseSetMetaData'
        db.create_table('scorecard_processor_responsesetmetadata', (
        ...
        db.send_create_signal('scorecard_processor', ['ResponseSetMetaData'])

        # Adding unique constraint on 'ResponseSetMetaData', fields ['response_set', 'key']
        db.create_unique('scorecard_processor_responsesetmetadata', ['response_set_id', 'key'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ResponseSetMetaData', fields ['response_set', 'key']
        db.delete_unique('scorecard_processor_responsesetmetadata', ['response_set_id', 'key'])

        # Deleting model 'ResponseSetMetaData'
        db.delete_table('scorecard_processor_responsesetmetadata')
    ...
    models = {
        ...
        'scorecard_processor.responsesetmetadata': {
            'Meta': {'unique_together': "(('response_set', 'key'),)", 'object_name': 'ResponseSetMetaData'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
