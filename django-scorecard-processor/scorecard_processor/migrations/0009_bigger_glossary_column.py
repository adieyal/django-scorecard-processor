...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GlossaryTerm.term'
        db.alter_column('scorecard_processor_glossaryterm', 'term', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'GlossaryTerm.term'
        db.alter_column('scorecard_processor_glossaryterm', 'term', self.gf('django.db.models.fields.CharField')(max_length=100))
