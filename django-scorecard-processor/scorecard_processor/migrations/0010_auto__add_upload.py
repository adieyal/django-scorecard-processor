...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Upload'
        db.create_table('scorecard_processor_upload', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('responseset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scorecard_processor.ResponseSet'])),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('scorecard_processor', ['Upload'])


    def backwards(self, orm):
        
        # Deleting model 'Upload'
        db.delete_table('scorecard_processor_upload')
