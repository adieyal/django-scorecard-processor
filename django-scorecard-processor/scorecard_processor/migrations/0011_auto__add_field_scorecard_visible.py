...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scorecard.visible'
        db.add_column('scorecard_processor_scorecard', 'visible', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Scorecard.visible'
        db.delete_column('scorecard_processor_scorecard', 'visible')
