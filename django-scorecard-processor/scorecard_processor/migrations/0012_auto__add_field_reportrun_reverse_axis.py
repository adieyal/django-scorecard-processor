...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReportRun.reverse_axis'
        db.add_column('scorecard_processor_reportrun', 'reverse_axis', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ReportRun.reverse_axis'
        db.delete_column('scorecard_processor_reportrun', 'reverse_axis')
    ...
    models = {
        ...
        'scorecard_processor.reportrun': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'reverse_axis': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'scorecard': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scorecard_processor.Scorecard']"})
        },
        ...
        'scorecard_processor.upload': {
            'Meta': {'object_name': 'Upload'},
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'responseset': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scorecard_processor.ResponseSet']"})
        }
    }
