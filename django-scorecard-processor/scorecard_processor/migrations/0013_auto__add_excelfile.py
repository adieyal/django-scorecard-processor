...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('scorecard_processor_excelfile', (
        ...
        db.send_create_signal('scorecard_processor', ['ExcelFile'])


    def backwards(self, orm):
        # Deleting model 'ExcelFile'
        db.delete_table('scorecard_processor_excelfile')
    ...
    models = {
        ...
        'scorecard_processor.scorecard': {
            'Meta': {'ordering': "('name',)", 'object_name': 'Scorecard'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scorecard_processor.Project']"}),
            'visible': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
