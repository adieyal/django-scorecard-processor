...
def box(request):
    ...
    for db_region in db_regions:
        ...
        all_value.sort()
        l_25 = int(round(len(all_value) * 0.25))
        l_50 = int(round(len(all_value) * 0.50))
        l_75 = int(round(len(all_value) * 0.75))
        region['q1'] = all_value[l_25 - 1]
        region['q2'] = all_value[l_50 - 1]
        region['q3'] = all_value[l_75 - 1]
