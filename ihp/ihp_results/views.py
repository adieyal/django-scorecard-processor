        ...
        for value, responses, response_set in iterate:
            if tick_mode:
                ...
                if not isinstance(question.plugin.plugin, MultiChoiceField):
                    ...
                    if isinstance(value,basestring) and value.lower() in ['si','qui','oui','non',u'en cours de développement','under development']:
                        value = {'si':'yes','qui':'yes','oui':'yes', 'non':'no',u'en cours de développement':'under_development','under development':'under_development'}[value.lower()]
