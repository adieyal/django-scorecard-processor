...
./manage.py migrate --noinput --settings=local_settings
...
./manage.py loaddata moz_results/project_data/project.json   --settings=local_settings 
./manage.py loaddata moz_results/project_data/entities.json   --settings=local_settings 
./manage.py loaddata moz_results/project_data/surveys.json --settings=local_settings 
./manage.py loaddata moz_results/project_data/reports.json   --settings=local_settings 
