...
echo -e "from django.contrib.sites import models;s=models.Site.objects.get_current();s.name='IHP+Results';s.domain='survey2012.mozresults.net';s.save();exit()" | epio django shell 
../deploy_moz.sh
